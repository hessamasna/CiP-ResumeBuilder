...
func (x *JwtIsValidResponse) GetIsValid() bool {
	if x != nil {
		return x.IsValid
	}
	return false
...
func (x *JwtIsValidRequest) GetJwtToken() string {
	if x != nil {
		return x.JwtToken
	}
	return ""
...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2e, 0x0a, 0x12, 0x4a, 0x77, 0x74, 0x49, 0x73, 0x56, 0x61, 0x6c,
	...
	,
...
var file_auth_service_proto_goTypes = []interface{}{
	(*JwtIsValidResponse)(nil), // 0: JwtIsValidResponse
	(*JwtIsValidRequest)(nil),  // 1: JwtIsValidRequest
}
var file_auth_service_proto_depIdxs = []int32{
	1, // 0: GprcAuthService.JwtIsValid:input_type -> JwtIsValidRequest
	0, // 1: GprcAuthService.JwtIsValid:output_type -> JwtIsValidResponse
...
func file_auth_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_auth_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JwtIsValidResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auth_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JwtIsValidRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
